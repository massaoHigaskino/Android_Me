...
public class BodyPartFragment extends Fragment {
    ...
    private static final String IMAGE_IDS_TAG = "mImageIds";
    private static final String LIST_INDEX_TAG = "mListIndex";
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        if(savedInstanceState != null) {
            mImageIds = savedInstanceState.getIntegerArrayList(IMAGE_IDS_TAG);
            mListIndex = savedInstanceState.getInt(LIST_INDEX_TAG);
        }
    ...
    public void onSaveInstanceState(Bundle outState) {
        ...
        outState.putIntegerArrayList(IMAGE_IDS_TAG, (ArrayList<Integer>) mImageIds);
        outState.putInt(LIST_INDEX_TAG, mListIndex);
    }
}
